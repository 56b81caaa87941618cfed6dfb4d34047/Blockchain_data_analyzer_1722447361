...
*/
Vue.component("simple_footer_component_1722447364", {
    template: `
    <footer id="footer-section" class="flex-1 bg-gradient-to-r from-pink-500 via-purple-500 to-black backdrop-blur-md bg-opacity-30">
            <div id="footer-container" class="max-w-screen-xl p-8 py-10 mx-auto lg:py-16 md:p-12 lg:p-14 rounded-2xl shadow-lg backdrop-filter backdrop-blur-lg bg-white bg-opacity-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-lg text-center text-pink-100">
                        Gain valuable insights into emerging blockchain data with our powerful analytics tools. Stay ahead of the curve with real-time analysis and visualization of blockchain transactions, smart contracts, and more. Try our free trial today!
                    </div>
                </div>
            </div>
        </footer> 
